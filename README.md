...
> Answer: when code is downloaded on the intital request to keep page from contining refresh after User clicks. The client side will update the data and navigate between pages 
- [ ] What does AJAX stand for?
> Answer: Asynchronous Javascript and XML
- [ ] What are `controlled components` in React?
> Answer: are values that are updated and dictated by React Components 
